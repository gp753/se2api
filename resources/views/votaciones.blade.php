...
<div class="row" >
   <div class="col-lg-12">
      <h1 class="page-header">
         Votaciones @{{user_id}} @{{administrador}} @{{login}}
      </h1>
   </div>
</div>
<div class="row" ng-hide="votando==true">

    
   <div class="col-sm-12" ng-repeat="x in votaciones">
            ...
            <div class="row">
               ...
               <div class="col-sm-6">
                  <div class="text-right">
                     <a href="#" ng-click="cargarVotacion(x.id)">Votar <i class="fa fa-arrow-circle-right"></i></a>
                  </div>
               </div>
            </div>
         </div>
...
@endsection
@section('javascript')
<script src="../js/angular/votaciones.js"></script>
@endsection