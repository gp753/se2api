...
<div class="row" ng-controller="AgregarCtrl" ng-init="a_error='';a_mensaje=''">
   <div class="col-lg-6">
      <div class="alert alert-danger" ng-show="a_error!=''">
            @{{a_error}}
      </div>
       <div class="alert alert-success" ng-show="a_mensaje!=''">
            @{{a_mensaje}}
       </div> 
      <form role="form">
         <div class="form-group">
            <label>Título</label>
            <input class="form-control" ng-model="a_titulo">
         </div>
         <div class="form-group">
            <label>Contenido</label>
            <textarea class="form-control" rows="3" ng-model="a_contenido"></textarea>
         </div>
          <button class="btn btn-default" ng-click="agregar(a_titulo, a_contenido)">Agregar</button>
      </form>
   </div>
</div>
<hr>
...
@endsection
@section('javascript')
<script src="../js/angular/administrador/noticias.js"></script>
@endsection